  ...
  return (
    <section id='about' className={styles.about}>
      ...
      <p className={styles.descriptionApp}>
        ...
        <br /> With a single tap, you record scores, and the technology takes care of the rest.
        <span className={styles.highlightedSentence}> Fast. Flawless. Effortless.</span>
        <br /> This isn’t just convenience — it’s the standard of the future, available today.
      </p>
    </section>
  );
}
